  ...
  <div class="relative" ref="dropdownRef">
    ...
    <div v-if="dropdownOpen"
      ...
      <div class="flex items-center justify-between pb-3 mb-3 border-b border-gray-100 dark:border-gray-800">
        <h5 class="text-lg font-semibold text-gray-800 dark:text-white/90">{{ $t('notifications.notification') }}</h5>
          ...
          <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
            ...
            <span class="block">
              <span class="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400">
                ...
                {{ $t('notifications.requestsPermission') }}
                <span class="font-medium text-gray-800 dark:text-white/90">
                  {{ $t('notifications.projectName') }}
                </span>
              </span>
              ...
              <span class="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
                ...
                <span>{{ $t('notifications.timeAgo', { time: 5 }) }}</span>
              </span>
            </span>
          </a>
        </li>
