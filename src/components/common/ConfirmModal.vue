<template>
  <div class="w-auto overflow-y-auto">
    <div class="flex justify-center">
      <div :class="[
        'relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 text-left shadow-xl transition-all w-auto',
        sizeClasses[size]
      ]">
        <!-- Content -->
        <div class="flex flex-col">
          ...
          <div class="flex mb-4 items-center">
            <div v-if="showIcon" :class="[
              ...
              <component :is="iconClasses[variant].icon" :class="[
                'h-5 w-5',
                iconClasses[variant].color
              ]" />
            </div>
...
import {
  CheckIcon, WarningIcon, InfoIcon, TrashIcon
} from '@/icons'
