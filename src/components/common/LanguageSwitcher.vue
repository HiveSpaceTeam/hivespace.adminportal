<template>
    <div class="relative">
        <button @click="toggleLanguageMenu"
            ...
            <svg v-if="currentLocale === 'vi'" class="w-5 h-5" viewBox="0 0 24 24" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <rect y="3" width="24" height="18" rx="3.67347" fill="#DA251D" />
                <path d="M12 6L13.5 10.5H18L14.25 13.5L15.75 18L12 15L8.25 18L9.75 13.5L6 10.5H10.5L12 6Z"
                    fill="#FFFF00" />
            </svg>
