<template>
  <Transition enter-active-class="transform ease-out duration-300 transition"
    ...
    <div v-if="visible"
      :class="['relative max-w-sm w-full shadow-lg rounded-xl border p-4 pointer-events-auto', variantClasses[variant].container]">
...
const variantClasses = {
  success: {
    container: 'border-success-500 bg-success-50 dark:border-success-500/30 dark:bg-success-500/15 backdrop-blur-sm',
    icon: 'text-success-500',
    progress: 'bg-success-500'
  },
  error: {
    container: 'border-error-500 bg-error-50 dark:border-error-500/30 dark:bg-error-500/15 backdrop-blur-sm',
    icon: 'text-error-500',
    progress: 'bg-error-500'
  },
  warning: {
    container: 'border-warning-500 bg-warning-50 dark:border-warning-500/30 dark:bg-warning-500/15 backdrop-blur-sm',
    icon: 'text-warning-500',
    progress: 'bg-warning-500'
  },
  info: {
    container: 'border-blue-light-500 bg-blue-light-50 dark:border-blue-light-500/30 dark:bg-blue-light-500/15 backdrop-blur-sm',
