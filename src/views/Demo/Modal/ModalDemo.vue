<template>
  <AdminLayout>
    ...
    <div class="space-y-5 sm:space-y-6">
      ...
      <!-- Modal Overview -->
      <ComponentCard title="Modal Popup Components"
        ...
        <div class="space-y-4">
          <p class="text-gray-600 dark:text-gray-400">
            ...
            confirmations,
            alerts, forms, and any content that requires user attention.
          </p>
          ...
          <div
            ...
            <p class="text-sm text-blue-700 dark:text-blue-300">
              All modals use <code class="bg-blue-100 dark:bg-blue-800 px-1 rounded">Teleport</code> to
              render at body level
              and include proper focus management and accessibility features.
            </p>
          </div>
        </div>
      </ComponentCard>
      ...
      <!-- Basic Modal Types -->
      <ComponentCard title="Basic Modal Types" description="Common modal patterns for different use cases">
      ...
      <ComponentCard title="Action-Specific Modals" description="Modals designed for specific user actions">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">

          <!-- Delete Confirmation -->
          <div class="p-4 border border-red-200 dark:border-red-800 rounded-lg bg-red-50 dark:bg-red-900/10">
            <h4 class="text-sm font-semibold text-red-800 dark:text-red-300 mb-2">Delete Confirmation</h4>
          ...
          <!-- Save/Discard -->
          <div class="p-4 border border-blue-200 dark:border-blue-800 rounded-lg bg-blue-50 dark:bg-blue-900/10">
            <h4 class="text-sm font-semibold text-blue-800 dark:text-blue-300 mb-2">Save Changes</h4>
      ...
      <!-- Advanced Examples -->
      <ComponentCard title="Advanced Modal Features"
      ...
      <ComponentCard title="Usage Examples & API">
        <div class="space-y-6">
          ...
          <!-- Basic Usage -->
          <div>
            <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">1. Basic Confirm Modal</h4>
            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 overflow-x-auto">
              <pre class="text-sm text-gray-700 dark:text-gray-300"><code>// Using useConfirmModal composable
...
const handleAction = async () => {
  ...
  if (confirmed) {
    // Handle confirmation
          ...
          <!-- Delete Modal -->
          <div>
            <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">2. Delete Confirmation</h4>
            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 overflow-x-auto">
              <pre class="text-sm text-gray-700 dark:text-gray-300"><code>// Using deleteConfirm helper
...
const handleDelete = async () => {
  ...
  if (confirmed) {
    // Delete the item
          ...
          <!-- Three Button Modal -->
          <div>
            <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">3. Three Button Modal</h4>
            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 overflow-x-auto">
              <pre class="text-sm text-gray-700 dark:text-gray-300"><code>// Using saveChanges helper for 3-button modal
...
import {
  CheckIcon, InfoIcon, WarningIcon, TrashIcon, EditIcon
} from '@/icons'
...
const showLoadingModal = async () => {
  ...
  if (confirmed === 'confirm') {
    ...
    const processing = await openConfirmModal({
...
const showCustomModal = async () => {
  ...
  if (result === 'confirm') {
    ...
    appStore.notifySuccess('User Created!', `User ${customForm.name} has been created successfully.`)
    resetCustomForm()
  }
}
