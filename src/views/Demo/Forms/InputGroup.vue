<template>
  <div class="space-y-6">
    <!-- Email Input -->
    <div>
      <BaseInput v-model="email" label="Email" placeholder="info@gmail.com" :inputClass="'pl-[62px]'">
        <template #prepend>
          <span
    ...
    <div>
      <BaseInput v-model="phoneNumber" label="Phone" placeholder="+1 (555) 000-0000" :inputClass="'pl-[84px]'">
        <template #prepend>
          <div class="absolute">
    ...
    <div>
      <BaseInput v-model="phoneNumber2" label="Phone" placeholder="+1 (555) 000-0000" :inputClass="'pr-[84px]'">
        <template #append>
    ...
    <!-- URL Input -->
    <div>
      <BaseInput v-model="url" label="URL" placeholder="www.tailadmin.com" :inputClass="'pl-[90px]'">
        <template #prepend>
          <span
    ...
    <div>
      <BaseInput v-model="website" label="Website" :inputClass="'pr-[90px] pl-4'">
        <template #append>
