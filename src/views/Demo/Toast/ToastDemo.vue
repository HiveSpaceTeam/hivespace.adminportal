<template>
    <AdminLayout>
        ...
        <div class="space-y-5 sm:space-y-6">
            ...
            <ComponentCard title="Toast Notifications - Basic Examples"
            ...
            <ComponentCard title="Custom Duration & Behavior"
            ...
            <ComponentCard title="Multiple Toasts & Management"
            ...
            <ComponentCard title="Real-world Use Cases"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 overflow-x-auto">
                            <pre class="text-sm text-gray-700 dark:text-gray-300"><code>import { useAppStore } from '@/stores/app'
...
appStore.notifyError(
  ...
  'Unable to connect to server. Please try again.'
                    ...
                    <!-- Custom Duration -->
                    <div>
                        <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">2. Custom Duration</h4>
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 overflow-x-auto">
...
appStore.addNotification({
  ...
  duration: 0  // 0 = no auto-close
                    ...
                    <!-- Form Integration -->
                    <div>
                        <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">3. Form Integration Example
                        </h4>
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 overflow-x-auto">
                            <pre class="text-sm text-gray-700 dark:text-gray-300"><code>const handleFormSubmit = async () => {
  try {
    ...
    appStore.setLoading(false)
                    ...
                    <!-- Multiple Management -->
                    <div>
                        <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">4. Toast Management</h4>
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 overflow-x-auto">
                            <pre class="text-sm text-gray-700 dark:text-gray-300"><code>// Get toast ID for manual control
                        ...
                        <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900 dark:text-white">
                                    notifySuccess</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">title: string, message?:
                                    string, duration?: number</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">string (toast ID)</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">Show green success toast
                                </td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900 dark:text-white">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">title: string, message?:
                                    string, duration?: number</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">string (toast ID)</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">Show red error toast</td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900 dark:text-white">
                                    notifyWarning</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">title: string, message?:
                                    string, duration?: number</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">string (toast ID)</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">Show yellow warning toast
                                </td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900 dark:text-white">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">title: string, message?:
                                    string, duration?: number</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">string (toast ID)</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">Show blue info toast</td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900 dark:text-white">
                                    addNotification</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">NotificationOptions</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">string (toast ID)</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">Advanced toast with full
                                    control</td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900 dark:text-white">
                                    removeNotification</td>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">Remove specific toast by
                                    ID</td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900 dark:text-white">
                                    clearAllNotifications</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">-</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">void</td>
                                <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">Clear all active toasts
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
import {
    ...
    PlusIcon, TrashIcon, CheckIcon, UploadIcon
} from '@/icons'
...
const showMultipleToasts = () => {
    const messages = [
        { type: 'success', title: 'First notification', message: 'This is the first toast in the sequence' },
        { type: 'warning', title: 'Second notification', message: 'This is the second toast that will stack below' },
        { type: 'info', title: 'Third notification', message: 'This is the third and final toast in this demo' }
    ]
