<template>
    <div class="space-y-6">
        ...
        <ComponentCard title="Advanced Toast Features" description="More sophisticated toast notification patterns">

            <div class="space-y-4">

                <!-- Progress Toast -->
                <div class="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <h4 class="text-sm font-semibold text-gray-800 dark:text-white mb-2">Progress Toast Example</h4>
                ...
                <!-- Conditional Toast -->
                <div class="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <h4 class="text-sm font-semibold text-gray-800 dark:text-white mb-2">Conditional Toasts</h4>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">
        ...
        <ComponentCard title="Toast Positioning & Styling"
        ...
        <ComponentCard title="Common Integration Patterns">
            <div class="space-y-4">
                ...
                <div class="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <h4 class="text-sm font-semibold text-gray-800 dark:text-white mb-2">Form Validation Pattern</h4>
                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 mb-3">
                        <pre class="text-xs text-gray-700 dark:text-gray-300"><code>const validateAndSubmit = async () => {
  if (!formData.email) {
  ...
  try {
    ...
    appStore.notifyError('Submission Failed', error.message)
                ...
                <div class="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <h4 class="text-sm font-semibold text-gray-800 dark:text-white mb-2">API Integration Pattern</h4>
                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 mb-3">
...
const simulateSuccessOperation = () => {
    setTimeout(() => {
        appStore.notifySuccess(
            ...
            'All items were processed without any issues.'
        )
    }, 500)
}
...
const simulatePartialOperation = () => {
    setTimeout(() => {
        appStore.notifyWarning(
            'Partial Success',
            '8 of 10 items were processed. 2 items had warnings.'
        )
    }, 500)
}
